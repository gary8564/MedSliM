...
CHECKPOINT_PATH="/hpcwork/rwth1833/checkpoints/MedSliM-pretraining/test-run-MRNet/2026-01-09-04:53/medslim_test_run_MRNet-epoch2000.pth.tar"  # Leave empty to use config file, or set path to override
